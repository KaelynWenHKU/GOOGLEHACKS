...
# 6. Reproduce the out-of-sample validation artifacts
...
The current HMM workflow is lightweight enough for a 16 GB Apple Silicon laptop. A remote GPU is only necessary if a materially larger neural-network component is added later.
